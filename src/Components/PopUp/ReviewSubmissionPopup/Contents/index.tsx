...
export function ReviewSubmissionContents({ reviewSubmissionDetail, reviewSubmissionDetailIsLoading }: PropsType) {
	return (
		<>
			{reviewSubmissionDetail ? (
				<_.Container>
					<_.TextWrapper>
						...
						<_.StudentText>{reviewSubmissionDetail?.writer}</_.StudentText>
					</_.TextWrapper>
					<_.ContentsBox>
