	...
	return (
		<_.Container>
			<_.Wrapper>
				...
				<_.ContentWrapper>
					<DropDown onChange={(type) => handleSelectedItem('company_type', type)} width={23} option={['전체', '선도기업', '참여기업']} value={selectedItem.company_type} />
				</_.ContentWrapper>
				<_.TitleText>지역</_.TitleText>
				<_.ContentWrapper width={8.5}>
					<DropDown
						onChange={(region) => handleSelectedItem('region', region)}
						width={90}
			...
			<_.Wrapper>
				...
				<_.ContentWrapper width={8.5}>
					<DropDown onChange={(industry) => handleSelectedItem('industry', industry)} width={90} option={allKeywords} value={selectedItem.industry} />
				</_.ContentWrapper>
				<_.Btn>
